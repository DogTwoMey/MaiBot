...
from .v36_to_v37 import create_maisaka_reply_effects_table
...
def migrate_v37_to_v38(context: MigrationExecutionContext) -> None:
    ...
    # 旧 fork 曾将“观察事件账本兼容迁移”登记为 v37，因此数据库版本已经是
    # 37 时也可能没有上游同版本引入的回复效果表。先幂等补齐基础表，再继续
    # 正常的 v37 -> v38 迁移，避免现有部署因版本号碰撞而跳过必要结构。
