...
def list_plugin_components(plugin_id: str, maibot_session: Optional[str] = auth_cookie()) -> Dict[str, Any]:
    """返回指定插件当前注册的全部组件。"""
...
def list_runtime_commands(maibot_session: Optional[str] = auth_cookie()) -> Dict[str, Any]:
...
def list_runtime_home_cards(maibot_session: Optional[str] = auth_cookie()) -> Dict[str, Any]:
...
def list_runtime_hook_specs(maibot_session: Optional[str] = auth_cookie()) -> HookSpecListResponse:
