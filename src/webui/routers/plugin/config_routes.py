...
def get_plugin_config_raw(plugin_id: str, maibot_session: Optional[str] = auth_cookie()) -> Dict[str, Any]:
    """获取插件原始 TOML 配置内容。
...
def reset_plugin_config(plugin_id: str, maibot_session: Optional[str] = auth_cookie()) -> Dict[str, Any]:
    """重置插件配置文件。
