...
def test_startup_bindings_use_defaults_when_config_file_missing(tmp_path: Path, monkeypatch):
...
def test_startup_bindings_can_read_addresses_from_bot_config(tmp_path: Path, monkeypatch):
    monkeypatch.delenv("WEBUI_HOST", raising=False)
