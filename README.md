...
- **发布**：[Release](https://github.com/MaiM-with-u/MaiBot/releases/) 页面展示了最新发布的正式版。<br>
...
- **[部署教程](https://docs.mai-mai.org/manual/deployment/)**<br>
<sub><sup>Deployment Guide</sup></sub>

- **方便使用的麦麦启动器下载 (Windows/MAC)**：[Maibot-OK](https://github.com/Mai-with-u/MaiBotOneKey/releases/)<br>
...
- **[📚 麦麦文档](https://docs.mai-mai.org)**：最全面的文档中心，了解麦麦的一切。<br>
...
- **[MoFox_Bot](https://github.com/MoFox-Studio/MoFox-Core)**：基于 MaiCore 0.10.0 的 Fork。<br>
...
- **[AstrBot](https://github.com/AstrBotDevs/AstrBot)**: 优秀的LLM Agent项目<br>
